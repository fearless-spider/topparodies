...
from sitesngine.pages.settings import SITESNGINE_PAGES_MEDIA_URL, SITESNGINE_PAGE_TAGGING
from sitesngine.pages.settings import SITESNGINE_PAGE_LANGUAGES
...
class RichTextarea(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        context = {
            'name': name,
            'PAGES_MEDIA_URL': SITESNGINE_PAGES_MEDIA_URL,
        }
