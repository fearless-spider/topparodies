# -*- coding: utf-8 -*-
"""Django Sites N-gine come with a set of ready to use widgets that you can enable
...
from sitesngine.pages.settings import SITESNGINE_PAGES_MEDIA_URL
from sitesngine.pages.settings import SITESNGINE_PAGE_TINYMCE, SITESNGINE_PAGE_LANGUAGES
from sitesngine.pages.models import Page
from sitesngine.pages.widgets_registry import register_widget
...
class RichTextarea(Textarea):
    ...
    class Media:
        js = [join(SITESNGINE_PAGES_MEDIA_URL, path) for path in (
            'javascript/jquery.js',
        )]
        css = {
            'all': [join(SITESNGINE_PAGES_MEDIA_URL, path) for path in (
                'css/rte.css',
            )]
        }
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        context = {
            'name': name,
            'SITESNGINE_PAGES_MEDIA_URL': SITESNGINE_PAGES_MEDIA_URL,
        }
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/richtextarea.html', context))


register_widget(RichTextarea)

if SITESNGINE_PAGE_TINYMCE:
    ...
    class TinyMCE(tinymce_widgets.TinyMCE):
        ...
        def render(self, name, value, attrs=None, **kwargs):
            ...
            return rendered + mark_safe(render_to_string(
                'sitesngine/pages/widgets/tinymce.html'))
...
class CKEditor(Textarea):
    ...
    class Media:
        js = [join(SITESNGINE_PAGES_MEDIA_URL, 'ckeditor/ckeditor.js'),
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/ckeditor.html', context))
...
class WYMEditor(Textarea):
    ...
    class Media:
        ...
        if "filebrowser" in getattr(settings, 'INSTALLED_APPS', []):
            js.append(join(SITESNGINE_PAGES_MEDIA_URL,
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/wymeditor.html', context))
...
class markItUpMarkdown(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/markitupmarkdown.html', context))
...
class markItUpRest(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/markituprest.html', context))
...
class markItUpHTML(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/markituphtml.html', context))
...
class EditArea(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'sitesngine/pages/widgets/editarea.html', context))
...
class LanguageChoiceWidget(TextInput):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        context = {
            ...
            'page': self.page,
            'language': value,
            'page_languages': SITESNGINE_PAGE_LANGUAGES
        }
        return mark_safe(render_to_string(
            'sitesngine/pages/widgets/languages.html', context))
