...
def get_page_templates():
    ...
    if isinstance(SITESNGINE_PAGE_TEMPLATES, collections.Callable):
...
def _default_tagging_field():
    ...
    return TagField()
SITESNGINE_PAGE_TAGGING_FIELD = getattr(settings, 'SITESNGINE_PAGE_TAGGING_FIELD', _default_tagging_field)
...
SITESNGINE_PAGE_CACHE_LOCATION = get_setting('SITESNGINE_PAGE_CACHE_LOCATION',
