...
class Page(MPTTModel):
    ...
    class Meta:
        ...
        permissions = settings.SITESNGINE_PAGE_EXTRA_PERMISSIONS
    ...
    def _get_calculated_status(self):
        ...
        if settings.SITESNGINE_PAGE_SHOW_START_DATE and self.publication_date:
            if self.publication_date > get_now():
                return self.DRAFT

        if settings.SITESNGINE_PAGE_SHOW_END_DATE and self.publication_end_date:
