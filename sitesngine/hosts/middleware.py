...
from utils import make_tls_property, current_site_id
    ...
    def process_request(self, request):
        ...
        if self.site:
            ...
            if folder_name:
                ...
                settings.STATICFILES_DIRS = (os.path.join(settings.SITES_DIR, folder_name, 'static'),)
...
class AdminLoginInterfaceSelectorMiddleware(object):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        login_type = request.POST.get("sitesngine_login_interface")
