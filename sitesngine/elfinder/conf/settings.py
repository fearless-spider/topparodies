...
ELFINDER_LANGUAGES = getattr(settings, 'ELFINDER_LANGUAGES',
                             ['ar', 'bg', 'ca', 'cs', 'de', 'el', 'es', 'fa', 'fr', 'hu', 'it', 'jp', 'ko', 'nl', 'no',
                              'pl', 'pt_BR', 'ru', 'tr', 'zh_CN'])
    ...
    'default': {
        ...
        'roots': [
            ...
            #},
            {
                'id': 'lff',
                'driver': ElfinderVolumeLocalFileSystem,
                'path': join(settings.MEDIA_ROOT, site.domain.replace('.', '_'), u'files'),
                'alias': 'Elfinder files',
                #open this path on initial request instead of root path
                #'startPath' : '',
                'URL': '%s%s/files/' % (settings.MEDIA_URL, site.domain.replace('.', '_')),
...
ELFINDER_TINYMCE_PATH_TO_POPUP_JS = getattr(settings, 'ELFINDER_TINYMCE_PATH_TO_POPUP_JS', None)
