...
from sitesngine.elfinder.conf import settings as ls
from sitesngine.elfinder.connector import ElfinderConnector
from sitesngine.elfinder.exceptions import ElfinderErrorMessages
...
class ConnectorEVLFOpen(unittest.TestCase):
    ...
    def test_open_path(self):
        ...
        self.assertEqual(ret['options']['path'],
                         '%s%sfiles%sdirectory' % (connector._default._root_name, os.sep, os.sep))
