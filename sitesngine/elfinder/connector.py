    ...
    def _mkdir(self, target, name):
        ...
        **Command**: Create a new directory. This method should not be invoked 
        ...
        try:
            ...
            return {
            'error': self.error(ElfinderErrorMessages.ERROR_MKDIR, name, ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND,
                                '#%s' % target)}
    ...
    def _mkfile(self, target, name):
        ...
        **Command**: Create a new, empty file. This method should not be invoked 
        ...
        try:
            ...
            return {
            'error': self.error(ElfinderErrorMessages.ERROR_MKFILE, name, ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND,
                                '#%s' % target)}
    ...
    def _paste(self, targets, dst, cut=False):
        ...
        **Command**: Copy/move ``targets`` files into a new destination ``dst``.
        ...
        try:
            ...
            return {
            'error': self.error(error, u'#%s' % targets[0], ElfinderErrorMessages.ERROR_TRGDIR_NOT_FOUND, u'#%s' % dst)}
